...
public class ExpressionPattern extends ZMatchFunction {
	...
	@Override public ZNode Invoke(ZNode ParentNode, ZTokenContext TokenContext, ZNode LeftNode) {
		return ExpressionPattern._DispatchPattern(ParentNode, TokenContext, LeftNode, false, true);
	}
	...
	public final static ZNode _DispatchPattern(ZNode ParentNode, ZTokenContext TokenContext, ZNode LeftNode, boolean AllowStatement, boolean AllowBinary) {
		...
		if(!Pattern.IsStatement) {
			while(LeftNode != null && !LeftNode.IsErrorNode()) {
				@Var ZSyntax RightPattern = ExpressionPattern._GetRightPattern(NameSpace, TokenContext);
