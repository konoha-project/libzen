...
public class MethodCallPattern extends ZMatchFunction {
	...
	@Override public ZNode Invoke(ZNode ParentNode, ZTokenContext TokenContext, ZNode LeftNode) {
		...
		MethodCallNode = TokenContext.MatchToken(MethodCallNode, ".", ZTokenContext.Required);
		MethodCallNode = TokenContext.MatchPattern(MethodCallNode, ZNode._NameInfo, "$Name$", ZTokenContext.Required);
